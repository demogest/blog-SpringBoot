package com.javaeeFirmant.blog.util;
...
//            List<Map<String, String>> data = (List) map.get("data");
            // Get Country, Region, City, Isp :
            return (String)map.get("country") + "," + map.get("regionName") + "," + map.get("city") + "," + map.get("isp");
            //return (String)map.get("country") + map.get("regionName") + map.get("city") + map.get("isp") + map.get("as");
        } catch (Exception e) {
            return "";
        }
    }
